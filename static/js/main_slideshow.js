...
(function ($) {
    ...
    */
    $.launch_date = [9, 7, 2020]; 										//-- launch date [d,m,yyyy], for example 7 September 2016 : [7,9,2016]
    $.bg_urls = ["img/background/s5.png", "img/background/s10.jpg"];
    ...
    $.wordrotator_words = ['<h4>Online Prediction System</h4>', '<h4>Recognition Algorithm</h4>']; //-- Array of words, for headline text
    ...
    $(document).ready(function (e) {
        ...
        //-- 6.17 activate YouTube video background
            ...
            if ($(window).width() >= 1200) {
                /*
                * Please note that this player doesn鈥檛 work as background for small devices (smartphone) due to the restriction policy adopted by all on
        ...
        //-- 6.18 activate self hosted video background
            ...
            if ($(window).width() >= 1200) {
                /*
                * Please note that this plugin doesn鈥檛 work as background for small devices (smartphone) due to the restriction policy adopted by all on
